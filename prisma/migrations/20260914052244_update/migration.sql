/*
  ...
  - You are about to drop the column `statisticsApplied` on the `GameResult` table. All the data in the column will be lost.
  - You are about to drop the column `statisticsApplied` on the `TeamGame` table. All the data in the column will be lost.
